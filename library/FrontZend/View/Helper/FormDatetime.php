 ...
 * @subpackage Helper
 */
class FrontZend_View_Helper_FormDatetime extends Zend_View_Helper_FormElement
{
    /**
     ...
     */
    public function formDatetime($name, $value = null, $attribs = null, $listsep = null)
    {
        ...
        $xhtml = '<div '
               ...
               . $this->view->formSelect($name.'[day]', $values['day'],
                    array_merge($selectAttribs, array('class' => 'input-small')), $days)
               . $listsep
               . $this->view->formSelect($name.'[month]', $values['month'],
                    array_merge($selectAttribs, array('class' => 'input-small')), $months)
               . $listsep
               . $this->view->formSelect($name.'[year]', $values['year'],
                    array_merge($selectAttribs, array('class' => 'input-small')), $years);

        if (strstr($format, 'HH:mm')) {
            $xhtml .= ' ' . PHP_EOL .
                      $this->view->formSelect($name.'[hour]', $values['hour'],
                        array_merge($selectAttribs, array('class' => 'input-small')), $hours)
                    . ' : ' . PHP_EOL . 
                      $this->view->formSelect($name.'[minute]', $values['minute'],
                         array_merge($selectAttribs, array('class' => 'input-small')), $minutes);
        }
